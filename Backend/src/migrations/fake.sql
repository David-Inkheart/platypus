...
insert into post (title, text, "creatorId")
values (
    'Mother and the Whore, The (Maman et la putain, La)',
    'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
...
insert into post (title, text, "creatorId")
values (
    'Consequences of Love, The (Conseguenze dell''amore, Le)',
...
insert into post (title, text, "creatorId")
values (
    'The Uncommon Making of Petulia',
    'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.',
    1
  );
insert into post (title, text, "creatorId")
...
insert into post (title, text, "creatorId")
values (
    'Koumiko Mystery, The (Mystère Koumiko, Le)',
    'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.
...
insert into post (title, text, "creatorId")
values (
    'Soldier of Orange (a.k.a. Survival Run) (Soldaat van Oranje)',
    'In congue. Etiam justo. Etiam pretium iaculis justo.',
    1
  );
insert into post (title, text, "creatorId")
...
insert into post (title, text, "creatorId")
values (
    'Close Your Eyes (Hypnotic) (Doctor Sleep)',
    'Proin interdum mauris non ligula pellentesque ultrices. Phasellus id sapien in sapien iaculis congue. Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.
...
insert into post (title, text, "creatorId")
values (
    'Case of the Grinning Cat, The (Chats perchés)',
    'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.
...
insert into post (title, text, "creatorId")
values (
    'Russia''s Toughest Prisons (National Geographic)',
    'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
...
insert into post (title, text, "creatorId")
values (
    'Challenge of the Masters (Liu A-Cai yu Huang Fei-Hong)',
    'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.
